...
local FireFromServer = Instance.new("BindableFunction")
FireFromServer.Name = "linkSlingBind"
FireFromServer.Parent = Tool
...
function FireFromServer.OnInvoke(targetPosition)
	fire(targetPosition)
end
