-- desert bandit 1 script - UPDATED for Simple Pathfinding and New Damage System
...
-- CUSTOMIZABLE BANDIT CONFIGURATION
local CONFIG = {
	-- Basic Stats
	maxHealth = 300,
	walkSpeed = 16,
	...
	-- Berserker Mode
	berserkerHealthThreshold = 0.50,
	berserkerSpeedMultiplier = 2,
	berserkerDashCooldown = 4,
	berserkerBombCooldown = 4,
	...
	combatSpeedMultiplier = 1.56, -- 25/16
...
-- Add damage resistance for desert bandit (15% damage resistance, 10% defense resistance)
...
defenseResistanceValue.Value = 0.1 -- 10% defense resistance
...
local WANDER_MESSAGES = {
	"Salam Alaykum",
	"where is the chai?",
	"walking to my mansion",
	"brother where is my laborghini?"
}
local CHASE_MESSAGE = "GET BACK HERE YOU STINKY GREENER"
local ATTACK_MESSAGE = "I WILL SLAUGHTER YOU LIKE A CHICKEN!!"
local LOST_TARGET_MESSAGE = "the pig ran away..."
local BOMB_MESSAGES = {
	"TASTE MY BOOM!",
	"EXPLOSIVE SURPRISE FOR YOU!"
}
...
-- [Previous wandering functions remain the same...]
...
-- Enhanced bomb throwing with customizable settings
...
local function checkBerserkerMode()
	...
	if healthPercent < CONFIG.berserkerHealthThreshold then
		...
		damageResistanceValue.Value = 0.25 -- 25% damage resistance when berserking
		...
		damageResistanceValue.Value = 0.15 -- Back to 15% normal resistance
