-- desert bandit 2 script - UPDATED for Simple Pathfinding
local EnemyPathfinding = require(game.ServerScriptService:WaitForChild("EnemyPathfinding"))
local Players = game:GetService("Players")
-- DESERT BANDIT 2 SCRIPT - UPDATED with New Damage System
-- (More defensive version of Bandit 1)
...
-- CUSTOMIZABLE BANDIT 2 CONFIGURATION
local CONFIG = {
	-- Basic Stats (slightly weaker than Bandit 1)
	maxHealth = 250,
	walkSpeed = 16,
	...
	-- Bomb Settings (slightly weaker than Bandit 1)
	bombDamage = {min = 100, max = 150},
	bombCooldown = 5,
	...
	-- Berserker Mode (more defensive)
	berserkerHealthThreshold = 0.35,
	...
	combatSpeedMultiplier = 1.375, -- 22/16
	combatRangeMultiplier = 3.5,
	pathUpdateInterval = 2,
	combatPathUpdateInterval = 0.6,
	combatDuration = 12
}
...
local CHASE_MESSAGE = "i can't let you run away.."
