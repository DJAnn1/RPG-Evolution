...
local enemyTemplate = serverStorage.enemies.area2.ghost
local spawnsFolder = workspace.enemySpawners.ghostSpawns
...
local function spawnEnemyAt(spawnPart)
	...
	humanoid.Died:Connect(function()
		...
		if #playersWhoDamaged > 0 then
			spawnEvents.ghostKilled:Fire(playersWhoDamaged)
		else
