...
local enemyTemplate = serverStorage.enemies.area2.linkEnemy
local spawnsFolder = workspace.enemySpawners.evilLinkSpawns
...
local function spawnEnemyAt(spawnPart)
	...
	humanoid.Died:Connect(function()
		...
		if #playersWhoDamaged > 0 then
			spawnEvents.linkKilled:Fire(playersWhoDamaged)
		else
