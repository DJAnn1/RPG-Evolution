...
local enemyTemplate = serverStorage.enemies.area2.ghostBoss
local spawnsFolder = workspace.enemySpawners.ghostBossSpawns
...
local function spawnEnemyAt(spawnPart)
	...
	humanoid.Died:Connect(function()
		...
		if #playersWhoDamaged > 0 then
			spawnEvents.ghostBossKilled:Fire(playersWhoDamaged)
		else
