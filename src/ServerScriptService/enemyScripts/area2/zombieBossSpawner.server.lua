...
local enemyTemplate = serverStorage.enemies.area2.ZombieBoss
local spawnsFolder = workspace.enemySpawners.zombieBoss
...
local function spawnEnemyAt(spawnPart)
	...
	humanoid.Died:Connect(function()
		...
		if #playersWhoDamaged > 0 then
			spawnEvents.zombieBossKilled:Fire(playersWhoDamaged)
		else
