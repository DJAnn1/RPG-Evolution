...
local enemyTemplate = serverStorage.enemies.area2.Zombie
local spawnsFolder = workspace.enemySpawners.zombieSpawns
...
local function spawnEnemyAt(spawnPart)
	...
	humanoid.Died:Connect(function()
		...
		if #playersWhoDamaged > 0 then
			spawnEvents.zombieKilled:Fire(playersWhoDamaged)
		else
