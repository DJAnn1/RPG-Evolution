...
local enemyTemplate = enemyFolder:WaitForChild("arab1")
local spawnsFolder = workspace.enemySpawners.arabSpawns.arab1
...
local function spawnEnemyAt(spawnPart)
	...
	humanoid.Died:Connect(function()
		...
		if #playersWhoDamaged > 0 then
			spawnEvents.arab1Killed:Fire(playersWhoDamaged)
		else
