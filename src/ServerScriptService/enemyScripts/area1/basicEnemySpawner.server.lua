...
local enemyTemplate = serverStorage.enemies.area1.enemy
local spawnsFolder = workspace.enemySpawners.enemySpawns
...
local function spawnEnemyAt(spawnPart)
	...
	humanoid.Died:Connect(function()
		...
		if #playersWhoDamaged > 0 then
			spawnEvents.EnemyKilled:Fire(playersWhoDamaged)
		end
