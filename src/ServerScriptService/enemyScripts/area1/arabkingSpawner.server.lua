--arabking Spawner Script

local serverStorage = game:GetService("ServerStorage")
local enemyFolder = serverStorage.enemies.area1
local enemyTemplate = enemyFolder:WaitForChild("arabKing")
local spawnsFolder = workspace.enemySpawners.arabSpawns.arabKing
...
local function spawnEnemyAt(spawnPart)
	...
	humanoid.Died:Connect(function()
		...
		if #playersWhoDamaged > 0 then
			spawnEvents.arabkingKilled:Fire(playersWhoDamaged)
		else
